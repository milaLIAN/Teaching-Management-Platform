...
public class ClassesService {
    ...
    public List<Classes> selectBySpeciality(Integer specialityId) {
        return classesMapper.selectBySpeciality(specialityId);
    }

    public Classes selectByTeacher(Integer teacherId) {
        return classesMapper.selectByTeacher(teacherId);
    }
}