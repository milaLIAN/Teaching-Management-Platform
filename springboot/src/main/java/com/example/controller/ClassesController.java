...
public class ClassesController {
    ...
    @GetMapping("/selectBySpeciality")
    public Result selectBySpeciality(@RequestParam("specialityId") Integer specialityId) {
        List<Classes> classes = classesService.selectBySpeciality(specialityId);
        return Result.success(classes);
    }

    @GetMapping("/selectByTeacher")
    public Result selectByTeacher(@RequestParam("teacherId") Integer teacherId) {
        Classes classes = classesService.selectByTeacher(teacherId);
        return Result.success(classes);
    }
}